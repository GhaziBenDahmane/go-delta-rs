...
func (c *deltaServiceClient) RewriteCheckpointMultipart(ctx context.Context, in *RewriteCheckpointMultipartRequest, opts ...grpc.CallOption) (*RewriteCheckpointMultipartResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(RewriteCheckpointMultipartResponse)
	err := c.cc.Invoke(ctx, DeltaService_RewriteCheckpointMultipart_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _DeltaService_RewriteCheckpointMultipart_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(RewriteCheckpointMultipartRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(DeltaServiceServer).RewriteCheckpointMultipart(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: DeltaService_RewriteCheckpointMultipart_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(DeltaServiceServer).RewriteCheckpointMultipart(ctx, req.(*RewriteCheckpointMultipartRequest))
	}
	return interceptor(ctx, in, info, handler)
}
